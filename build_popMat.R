build_popMat <- function(growth_rate, growth_rate_sd,
  ...
  if(stochastic){
    ...
    lambda <- growth_rate
    init_adultProp <- init_adultProp_mean
  }
  ...
  ## Build projections matrix
  # (1 = juvenile, < 1 year old; 2 = adult, > 1 year old)
